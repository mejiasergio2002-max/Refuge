        ...
        <div className="panel p-8 md:p-10">
          ...
          <div className="mt-10 space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <label className="block text-sm text-white/75 mb-2">first name</label>
                <input className="field" type="text" />
              </div>
              <div>
                <label className="block text-sm text-white/75 mb-2">last name</label>
                <input className="field" type="text" />
              </div>
            </div>
            ...
            {/* username */}
            <div>
              <label className="block text-sm text-white/75 mb-2">username</label>
              <input className="field" type="text" />
            </div>

            {/* password + confirm (two columns, confirm has show button) */}
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
              ...
              <div>
                <label className="block text-sm text-white/75 mb-2">confirm password</label>
                <div className="flex gap-3">
                  <input className="field" type="password" />
                  <button
                    type="button"
                    className="border border-green-400/60 bg-black/30
